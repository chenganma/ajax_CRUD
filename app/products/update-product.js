$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
		...
		$.getJSON("https://chenganma.com/apifolder/product/read_one.php?id=" + id, function(data){
			...
			$.getJSON("https://chenganma.com/apifolder/category/read.php", function(data){
	...
	$(document).on('submit', '#update-product-form', function(){
		...
		$.ajax({
		    url: "https://chenganma.com/apifolder/product/update.php",
		    type : "POST",
